  ...
  return (
    <div className="wrapped">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Samuel
        Mothwa.
      </p>{" "}
      <p>
        Samuel Mothwa is committed to ensuring that the app is as useful and
      ...
      <p>
        The Ultimate News app stores and processes personal data that you have
        ...
        features and it could mean that the Ultimate News app won’t work
        properly or at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Samuel Mothwa
        ...
        can be Wi-Fi or provided by your mobile network provider, but Samuel
        Mothwa cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Samuel Mothwa cannot always take responsibility
        ...
        avail the Service, Samuel Mothwa cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Samuel Mothwa’s responsibility for your use of the app,
        ...
        it available to you. Samuel Mothwa accepts no liability for any loss,
      ...
      <p>
        ...
        updates if you want to keep using the app. Samuel Mothwa does not
      ...
      <p>These terms and conditions are effective as of 2022-03-29</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at northernbreeze.za@gmail.com.
      </p>{" "}
      <p>
